...
/* harmony import */ var _targetcompany_targetcompany_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./targetcompany/targetcompany.component */ "./src/app/targetcompany/targetcompany.component.ts");
...
var routes = [
    ...
    {
        path: 'targetcompany',
        component: _targetcompany_targetcompany_component__WEBPACK_IMPORTED_MODULE_3__["TargetCompanyComponent"]
    }
];
...
/* harmony import */ var _targetcompany_targetcompany_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./targetcompany/targetcompany.component */ "./src/app/targetcompany/targetcompany.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _targetcompany_targetcompany_component__WEBPACK_IMPORTED_MODULE_7__["TargetCompanyComponent"]
            ],
            imports: [
...
module.exports = "<div class=\"container\">\n  <div class=\"template\">\n    <h1>Target Company Tracker for assessing the potential companies in market</h1>\n  </div>\n</div>\n"
...
/***/ "./src/app/targetcompany/targetcompany.component.html":
/*!************************************************************!*\
  !*** ./src/app/targetcompany/targetcompany.component.html ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./src/app/targetcompany/targetcompany.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/targetcompany/targetcompany.component.ts ***!
  \**********************************************************/
/*! exports provided: TargetCompanyComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TargetCompanyComponent", function() { return TargetCompanyComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var TargetCompany = /** @class */ (function () {
    function TargetCompany(ID, companyName, keyContact, status, financialPerformance) {
        if (ID === void 0) { ID = ''; }
        if (companyName === void 0) { companyName = ''; }
        if (keyContact === void 0) { keyContact = ''; }
        if (status === void 0) { status = 'Select Status'; }
        if (financialPerformance === void 0) { financialPerformance = ''; }
        this.ID = ID;
...
var TargetCompanyComponent = /** @class */ (function () {
    function TargetCompanyComponent() {
        ...
        this.statuses = ['Researching', 'Pending Approval', 'Approved', 'Declined'];
    ...
    TargetCompanyComponent.prototype.getFinancialPerfByCompany = function () {
    ...
    TargetCompanyComponent.prototype.ngOnInit = function () {
    };
    // This method associate to New Button.
    TargetCompanyComponent.prototype.onNew = function () {
    ...
    TargetCompanyComponent.prototype.onSave = function () {
    ...
    TargetCompanyComponent.prototype.onEdit = function (index) {
    ...
    TargetCompanyComponent.prototype.onDelete = function (index) {
    ...
    TargetCompanyComponent.prototype.onCancel = function () {
        // Hide add company form.
        this.showNew = false;
    };
    // This method associate to Bootstrap dropdown selection change.
    TargetCompanyComponent.prototype.onChangeStatus = function (status) {
        // Assign corresponding selected country to model.
        this.companyModel.status = status;
    };
    // events
    TargetCompanyComponent.prototype.chartClicked = function (e) {
        console.log(e);
    };
    TargetCompanyComponent.prototype.chartHovered = function (e) {
        console.log(e);
    };
    __decorate([
    ...
    ], TargetCompanyComponent.prototype, "chart", void 0);
    TargetCompanyComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'target-company',
            template: __webpack_require__(/*! ./targetcompany.component.html */ "./src/app/targetcompany/targetcompany.component.html"),
        }),
        __metadata("design:paramtypes", [])
    ], TargetCompanyComponent);
    return TargetCompanyComponent;
}());
...
module.exports = __webpack_require__(/*! C:\Users\admin\Downloads\target-company-tracker\src\main.ts */"./src/main.ts");
